...
These documents are written for coding agents and maintainers working in this repository.

- [Architecture](architecture.md): package responsibilities, request flow, lobby lifecycle, and core invariants.
